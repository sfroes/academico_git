...
{
    public class CurriculoCursoOfertaGrupoListarDynamicModel : SMCDynamicViewModel, ISMCTreeNode
    {
        #region [ Comum ]
        ...
        /// </summary>
        [SMCHidden]
        public Academico.Common.Areas.CUR.Enums.FormatoConfiguracaoGrupo? FormatoConfiguracaoGrupo { get; set; }

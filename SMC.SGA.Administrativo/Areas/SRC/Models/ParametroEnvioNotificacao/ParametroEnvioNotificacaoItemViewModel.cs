...
{
    public class ParametroEnvioNotificacaoItemViewModel : SMCViewModelBase
    {
        [SMCKey]
        [SMCHidden]
        ...
        [SMCDependency(nameof(ParametroEnvioNotificacaoViewModel.SeqProcesso))]
        [SMCHidden(SMCViewMode.List)]
        [SMCRequired]
        [SMCSize(SMCSize.Grid18_24, SMCSize.Grid24_24, SMCSize.Grid13_24, SMCSize.Grid18_24)]
        //[SMCConditionalReadonly(nameof(PossuiNotificacaoEnviada), SMCConditionalOperation.Equals, true, PersistentValue = true)]
        ...
        public GrupoEscalonamentoLookupViewModel ListaGrupoEscalonamento => SeqGrupoEscalonamento;

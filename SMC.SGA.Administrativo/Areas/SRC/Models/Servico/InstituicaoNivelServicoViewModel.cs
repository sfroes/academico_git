...
{
    public class InstituicaoNivelServicoViewModel : SMCWizardViewModel, ISMCStatefulView
    {
        [SMCKey]
        [SMCHidden]
        ...
        [SMCRequired]
        [SMCSelect(nameof(ServicoViewModel.TiposTransacao))]
        [SMCConditionalDisplay(nameof(ServicoViewModel.ExibirCampoTipoTransacao), SMCConditionalOperation.Equals, true)]        
        [SMCSize(SMCSize.Grid7_24, SMCSize.Grid24_24, SMCSize.Grid7_24, SMCSize.Grid7_24)]

...
using SMC.AgendadorTarefa.UI.Mvc.Util;
using SMC.AssinaturaDigital.UI.Mvc;
...
namespace SMC.SGA.Administrativo
{
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            // Configura as rotas para os Agendador de Tarefas
            routes.RegistraRotaAgendadorTarefas();

            //Diploma
            routes.RegistrarRotaAssinaturaDigital();

...
{
    public class InstituicaoNivelHierarquiaClassificacaoValidator : SMCValidator<InstituicaoNivelHierarquiaClassificacao>
    {
        protected override void DoValidate(InstituicaoNivelHierarquiaClassificacao item, SMCValidationResults validationResults)
        {

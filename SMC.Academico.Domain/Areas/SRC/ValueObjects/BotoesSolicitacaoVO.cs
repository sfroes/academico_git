...
{
    public class BotoesSolicitacaoVO : ISMCMappable
    {
        ...
        public bool SituacaoAtualSolicitacaoDiferenteEncerrada { get; set; }
        ...
        public bool EtapaAtualDisponivelNaCentralDeSolicitacoes { get; set; }

...
{
    public class ProcessoEtapaDetalheVO : ISMCMappable
    {
        ...
        public List<EscalonamentoVO> Escalonamentos { get; set; }

        public List<ProcessoEtapaConfiguracaoNotificacaoVO> ConfiguracoesNotificacao { get; set; }

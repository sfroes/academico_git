...
{
    public class DocumentoConclusaoEntidadeResponsavelCustomFilter : SMCCustomFilter<DocumentoConclusao>
    {
        ...
        {
            return x => SeqsHierarquias.Contains(x.Aluno.Historicos.FirstOrDefault(f => f.Atual).EntidadeVinculo.HierarquiasEntidades.FirstOrDefault().Seq);
        }
    }
}

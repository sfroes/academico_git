...
{
    public class AtoRegulatorioVO : ISMCMappable
    {
        public string Tipo { get; set; } //enum Parecer, Resolucao, Decreto, Portaria, Deliberação, Lei Federal, Lei Estadual, Lei Municipal, Ato Próprio

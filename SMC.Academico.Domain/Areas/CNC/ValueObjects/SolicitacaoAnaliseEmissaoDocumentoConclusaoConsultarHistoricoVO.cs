...
{
    public class SolicitacaoAnaliseEmissaoDocumentoConclusaoConsultarHistoricoVO : ISMCMappable
    {
        ...
        public List<SolicitacaoAnaliseEmissaoDocumentoConclusaoConsultarEnadeVO> Enade { get; set; }
    }
}

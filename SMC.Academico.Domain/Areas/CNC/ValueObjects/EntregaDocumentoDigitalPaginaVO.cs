...
{
    public class EntregaDocumentoDigitalPaginaVO : ISMCMappable
    {
        ...
        public List<EntregaDocumentoDigitalFiliacaoPaginaVO> Filiacao { get; set; }

        public List<string> FiliacaoDisplay { get; set; }

        public List<EntregaDocumentoDigitalDocumentoConclusaoPaginaVO> DocumentosConclusao { get; set; }

        public bool? ConfirmacaoAluno { get; set; }

        public string Observacao { get; set; }

        public List<EntregaDocumentoDigitalUploadPaginaVO> DocumentosUpload { get; set; }
    }
}

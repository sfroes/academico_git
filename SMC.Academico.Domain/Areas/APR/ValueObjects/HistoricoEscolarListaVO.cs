...
{
    public class HistoricoEscolarListaVO : ISMCMappable, ISMCSeq
    {
        ...
        public string DescricaoAlunoHistoricoCicloLetivo { get; set; }

        public string DescricaoAlunoHistoricoCursoOfertaLocalidade { get; set; }

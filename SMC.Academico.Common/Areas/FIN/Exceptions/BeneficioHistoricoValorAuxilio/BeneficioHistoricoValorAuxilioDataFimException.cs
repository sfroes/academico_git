...
{
    public class BeneficioHistoricoValorAuxilioDataFimException : SMCApplicationException
    {
        public BeneficioHistoricoValorAuxilioDataFimException(string status)

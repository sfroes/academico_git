...
import { SmcNotificationService } from './../../../../../../../shared/services/notification/smc-notification.service';
...
export class EventoAulaAgendamentoEditColaboradorSubstitutoComponent implements AfterViewInit, OnDestroy {
  ...
  getProfessores() {
    return (this.formEdit.controls.colaboradores as FormArray).controls;
  }
  ...
  async onSubmit() {
    ...
    try {
      ...
      await this.service.editarColaboradoresEventos(colaboradores, seqEventos, seqEventoTemplate, false);

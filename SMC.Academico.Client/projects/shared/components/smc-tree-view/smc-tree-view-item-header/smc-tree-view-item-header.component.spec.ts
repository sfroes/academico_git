...
import { SmcTreeViewItemHeaderComponent } from './smc-tree-view-item-header.component';

describe('SmcTreeViewItemHeaderComponent:', () => {
  let component: SmcTreeViewItemHeaderComponent;
  let fixture: ComponentFixture<SmcTreeViewItemHeaderComponent>;
  let debugNativeElement;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [FormsModule, PoFieldModule],
      declarations: [SmcTreeViewItemHeaderComponent]
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(SmcTreeViewItemHeaderComponent);
  ...
  it('should create', () => {
    ...
    expect(component instanceof SmcTreeViewItemHeaderComponent).toBeTruthy();
  });

...
namespace SMC.Academico.ServiceContract.Areas.PES.Data
    ...
    public class ConfiguracaoAvaliacaoPpaData : ISMCMappable
    {
        ...
        public int TipoAvaliacaoPpa { get; set; }
        ...
        //public IList<PessoaAtuacaoAmostraPpa> Amostras { get; set; }

        //public Entidade EntidadeResponsavel { get; set; }

        //public CicloLetivo CicloLetivo { get; set; }

        //public IList<ConfiguracaoAvaliacaoPpaTurma> Turmas { get; set; }

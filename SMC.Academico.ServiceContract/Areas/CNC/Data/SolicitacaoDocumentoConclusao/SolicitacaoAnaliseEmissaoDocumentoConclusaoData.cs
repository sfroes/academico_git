...
{
    public class SolicitacaoAnaliseEmissaoDocumentoConclusaoData : ISMCMappable
    {
        ...
        public List<SolicitacaoAnaliseEmissaoDocumentoConclusaoFormacaoConcluidaData> FormacoesEspecificasConcluidas { get; set; }

        public List<SolicitacaoAnaliseEmissaoDocumentoConclusaoFormacaoConcluidaData> FormacoesEspecificasViasAnteriores { get; set; }
        ...
        public List<SolicitacaoAnaliseEmissaoDocumentoConclusaoDocumentacaoData> DocumentacaoComprobatoria { get; set; }

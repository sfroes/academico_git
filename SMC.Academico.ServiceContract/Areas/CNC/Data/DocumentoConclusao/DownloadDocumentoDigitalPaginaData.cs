...
{
    public class DownloadDocumentoDigitalPaginaData : ISMCMappable
    {
        ...
        public List<DownloadDocumentoDigitalDocumentoConclusaoPaginaData> DocumentosConclusao { get; set; }

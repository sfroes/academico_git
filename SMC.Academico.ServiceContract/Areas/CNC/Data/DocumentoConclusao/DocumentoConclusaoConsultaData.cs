...
{
    public class DocumentoConclusaoConsultaData : ISMCMappable
    {
        ...
        public List<DocumentoConclusaoFormacaoListarData> FormacoesEspecificas { get; set; }
        ...
        public DocumentoConclusaoFiltroHistoricoDownloadData FiltroHistoricoDownload { get; set; }

        public List<DocumentoConclusaoHistoricoListarData> Situacoes { get; set; }

        public List<DocumentoConclusaoViaAnteriorListarData> DocumentoConclusaoViaAnterior { get; set; }

        public List<DocumentoConclusaoMensagemData> InformacoesAdicionais { get; set; }
        ...
        public string MensagemBotaoApostilamento { get; set; }

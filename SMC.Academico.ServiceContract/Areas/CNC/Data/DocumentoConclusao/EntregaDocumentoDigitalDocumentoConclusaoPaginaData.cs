...
{
    public class EntregaDocumentoDigitalDocumentoConclusaoPaginaData : ISMCMappable
    {
        ...
        public List<EntregaDocumentoDigitalFormacaoPaginaData> FormacoesEspecificas { get; set; }
    }
}

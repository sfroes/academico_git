...
{
    public class TurmaConfiguracaoCicloLetivoData : ISMCMappable
    {
        ...
        public List<DivisaoTurmaCicloLetivoData> DivisoesTurma { get; set; }

        public short? AlunosMatriculados { get; set; }

        public List<ColaboradorTurmaConfiguracaoCicloLetivoData> Colaboradores { get; set; }

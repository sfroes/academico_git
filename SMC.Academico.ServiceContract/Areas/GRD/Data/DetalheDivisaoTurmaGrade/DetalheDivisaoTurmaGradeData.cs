...
{
    public class DetalheDivisaoTurmaGradeData : ISMCMappable
    {
        ...
        public List<DetalheDivisaoTurmaGradeProfessorData> Professores { get; set; }

        public List<DetalheDivisaoTurmaGradeLocalData> LocaisAula { get; set; }
    }
}

...
{
    public class PaginaAdesaoContratoRenovacaoMatriculaViewModel : MatriculaPaginaViewModelBase
    {
        public override string Token => MatriculaTokens.ADESAO_CONTRATO_RENOVACAO;
        ...
        public List<InformacaoFinanceiraTermoAcademicoViewModel> InformacoesFinanceiras { get; set; }

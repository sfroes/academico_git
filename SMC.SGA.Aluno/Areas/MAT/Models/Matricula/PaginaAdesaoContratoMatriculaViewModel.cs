...
{
    public class PaginaAdesaoContratoMatriculaViewModel : MatriculaPaginaViewModelBase
    {
        public override string Token => MatriculaTokens.ADESAO_CONTRATO_MATRICULA;

...
using SMC.Financeiro.UI.Mvc;
using SMC.Framework.UI.Mvc.Global;
using SMC.Seguranca.UI.Mvc;

[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(SMC.SGA.Aluno.RazorGeneratorMvcStart), "Start")]
...
namespace SMC.SGA.Aluno
{
    public static class RazorGeneratorMvcStart
    {
        ...
        public static void Configure()
        {
            ...
            var uiMVC_Seguranca = new PrecompiledMvcEngine(typeof(SegurancaExternalViews).Assembly)
            {
                UsePhysicalViewsIfNewer = view
            };

            var uiMVCFinanceiro = new PrecompiledMvcEngine(typeof(FinanceiroExternalViews).Assembly)
            {
                UsePhysicalViewsIfNewer = view
            };
            ...
            ViewEngines.Engines.Add(uiMVCFinanceiro);

            ViewEngines.Engines.Add(uiMVC_Seguranca);

...
namespace ASP
{
    ...
    #line 2 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
    using SMC.Academico.Common.Areas.SRC.Constants;
    
    #line default
    #line hidden
    
    #line 3 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
    using SMC.Academico.Common.Constants;
    
    #line default
    #line hidden
    
    #line 1 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
    using SMC.Academico.UI.Mvc.Areas.SRC.Models;
    
    #line default
    #line hidden
    
    #line 4 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/SRC/Views/SolicitacaoServicoFluxoBase/_DocumentacaoSolicitacao.cshtml")]
    public partial class _Areas_SRC_Views_SolicitacaoServicoFluxoBase__DocumentacaoSolicitacao_cshtml : SMC.Framework.UI.Mvc.SMCWebViewPage<DadosModalSolicitacaoServicoViewModel>
    {
        public _Areas_SRC_Views_SolicitacaoServicoFluxoBase__DocumentacaoSolicitacao_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 8 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
Write(Smc.EditorFor(x => x.ExibirComprovanteMatriculaETermoAdesao));
...
WriteLiteral("\r\n");
            ...
            #line 11 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
 if (Model.ExibirComprovanteMatriculaETermoAdesao)
{
    using (Smc.Fieldset("Documentos").LegendText("Documentos da matrícula").Size(SMCSize.Grid24_24).Begin())
    {
            ...
            Model.Solicitacao.TokenTipoServico == TOKEN_TIPO_SERVICO.PLANO_ESTUDO)
        {
            ...
            #line 75 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
       Write(buttonSet);
...
WriteLiteral("\r\n\r\n");
            ...
            #line 81 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
 if (Model.DocumentosSolicitacao.Count > 0)
{
    using (Smc.Fieldset("Documentos").LegendText("Documentos").CssClass("smc-sga-confirmacao-dados").Begin())
    {
            ...
            #line 85 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
    Write(Smc.Grid("gridDocumentos", new SMCPagerModel<DadosModalSolicitacaoDocumentoViewModel>(Model.DocumentosSolicitacao))
            ...
            #line 107 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
...
WriteLiteral("><i>Não há documentação requerida para esse tipo de solicitação.</i></p>\r\n");

            
            #line 114 "..\..\Areas\SRC\Views\SolicitacaoServicoFluxoBase\_DocumentacaoSolicitacao.cshtml"
}

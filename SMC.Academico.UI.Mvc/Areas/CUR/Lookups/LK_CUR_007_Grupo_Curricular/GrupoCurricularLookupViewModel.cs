...
{
    public class GrupoCurricularLookupViewModel : SMCViewModelBase, ISMCLookupData, ISMCMappable
    {
        #region [ Comum ]
        ...
        /// </summary>
        [SMCHidden]
        public Common.Areas.CUR.Enums.FormatoConfiguracaoGrupo? FormatoConfiguracaoGrupo { get; set; }
        ...
        public string DescricaoFormatada
        {
            get
            {
                ...
                if (CargaHoraria.HasValue && !string.IsNullOrEmpty(Formato) && !SeqGrupoCurricular.HasValue)
                    if (retorno.Length > 0)
                        retorno += $" - {CargaHoraria} - {Formato}";
                    else
                        retorno = $"{CargaHoraria} - {Formato}";
